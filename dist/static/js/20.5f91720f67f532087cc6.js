...
// module
exports.push([module.i, ".iodetail{margin-top:2.2rem}.iod_title{display:-webkit-box;display:-ms-flexbox;display:flex;background-color:#fff;height:1.5rem;line-height:1.5rem;padding:0 1rem;font-size:.6rem}.iod_detail{padding:.5rem;background:#fff;margin-top:.5rem;margin-bottom:1rem}.iod_detail ul li{width:100%;font-size:.55rem;padding-left:.8rem;height:1.2rem;line-height:1.2rem}.iod_detail ul li.detail{min-height:2.5rem;color:#999;line-height:1rem}.iod_detail .fyqd{min-height:4rem}", "", {"version":3,"sources":["E:/app/GZapp/src/page/iodetail.vue"],"names":[],"mappings":"AACA,UACI,iBAAkB,CACrB,AACD,WACI,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,sBAAuB,AACvB,cAAe,AACf,mBAAoB,AACpB,eAAe,AACf,eAAiB,CACpB,AACD,YACI,cAAc,AACd,gBAAgB,AAChB,iBAAiB,AACjB,kBAAmB,CACtB,AACD,kBACI,WAAY,AACZ,iBAAkB,AAClB,mBAAmB,AACnB,cAAc,AACd,kBAAmB,CACtB,AACD,yBACI,kBAAmB,AACnB,WAAW,AACX,gBAAiB,CACpB,AACD,kBACI,eAAgB,CACnB","file":"iodetail.vue","sourcesContent":["\n.iodetail {\n    margin-top:2.2rem;\n}\n.iod_title {\n    display: -webkit-box;\n    display: -ms-flexbox;\n    display: flex;\n    background-color: #fff;\n    height: 1.5rem;\n    line-height: 1.5rem;\n    padding:0 1rem;\n    font-size: .6rem;\n}\n.iod_detail {\n    padding:.5rem;\n    background:#fff;\n    margin-top:.5rem;\n    margin-bottom:1rem;\n}\n.iod_detail ul li {\n    width: 100%;\n    font-size: .55rem;\n    padding-left:.8rem;\n    height:1.2rem;\n    line-height:1.2rem;\n}\n.iod_detail ul li.detail {\n    min-height: 2.5rem;\n    color:#999;\n    line-height:1rem;\n}\n.iod_detail .fyqd {\n    min-height:4rem;\n}\n"],"sourceRoot":""}]);
...
var update = __webpack_require__(13)("69ee07ff", content, true);
...
//# sourceMappingURL=20.5f91720f67f532087cc6.js.map