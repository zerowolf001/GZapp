...
<script>
  ...
  import {yzDetail} from '../service/getData'
...
<style lang="scss">
  ...
  .yz_detail .profileImage .user-info {
    padding-left: .4rem;
    -webkit-box-flex: 1;
    -webkit-flex-grow: 1;
    -ms-flex-positive: 1;
  ...
  .yz_detail .profileImage .user-info header {
    display: flex;
    align-items: center;
  .lv_1:before{
    font-size: .5rem;
  ...
  .yz_detail .profileImage .user-info .bed_title {
    display: block;
    margin: 0;
    width: 3.5rem;
    color: #333;
  ...
  .yz_detail .profileImage .user-info header p{
    margin-top: 0;
    display: block;
  &.age {
     float:left;
  ...
  .yz_detail .user-info .bed_distance {
    display: flex;
    width: 100%;
    font-size:.55rem;
    line-height:.75rem;
  ...
  .yz_detail .profileImage .user-info p {
    margin-top:-.4rem;
  }
  .yz_detail .user-info .bed_distance p:first-child {
    margin-top:0;
    width:70%;
  }
  .yz_detail .user-info .bed_distance p:last-child {
    margin-top:0;
    color:#f0665a;
    line-height: 1.2rem;
    font-size:.65rem;
